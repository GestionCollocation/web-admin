...
<div class="content">
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-warning" style="width: 50%;">
                <h4 class="card-title" style="font-weight: bold;" >Les utilisateurs</h4>
              ...
              <div class="card-body table-responsive">
                <table class="table table-hover" style="width: 100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td  style="width: 5%;">{{$tem->id}}</td>
                      <td style="width: 10%;">
                         <img src="{{ URL::asset($tem->profile_image) }}" alt="" style=" border-radius: 50%; width: 40px; height: 40px; "> 
                       </td>
                      <td  style="width: 10%;">{{$tem->name}}</td>
                      <td>{{$tem->email}}</td>
                      <td  style="width: 5%;">{{$tem->sexe}}</td>
                      <td  style="width: 8%;">{{$tem->telephone}}</td>
                      <td >{{$tem->apropos}}</td>
