      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header card-header-primary "style="width: 70%; background-color: rgb(41,195,72) !important ; ">
            <h4 class="card-title">Le profile du</h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="chihaja" class="form-control">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating">Email address</label>
                    <input type="email" class="form-control" value="chihaja@gmail.com">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="06545465465">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="5">sdfsdfd</textarea>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-md-4">
        <div class="card card-profile">
          ...
          <div class="card-body">
            ...
            <a href="javascript:;" class="btn  btn-round" style=" background: rgb(207, 48, 42);">Supprimer</a>
          </div>
        </div>
      </div>
    </div>
