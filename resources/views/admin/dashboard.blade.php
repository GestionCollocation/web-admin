    ...
    <div class="sidebar" data-color="green" data-background-color="white" data-image="{{asset('assets/img/sidebar-1.jpg')}}">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/admin/annonces">
              <i class="material-icons">
                article
              </i>
              <p>Les annnonces</p>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Bienvenue Admin</a>
          </div>
            ...
            <div class="col-lg-4 col-md-3 col-sm-6">
              <div class="card card-stats" >
                <div class="card-header card-header-warning card-header-icon" >
                  <div class="card-icon"  style="background-color: darkorange;">
                    <i class="material-icons">
                      business
                    </i>
                  </div>
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Dernier 24 heures
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-3 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon" style=" background-color: rgb(41,195,72) !important ; ">
                    <i class="material-icons">
                      article
                    </i>
                  </div>
            ...
            <div class="col-lg-4 col-md-3 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon" style=" background: rgb(4,81,142);">
                    <i class="material-icons">
                      people
                    </i>
                  </div>
                ...
                <div class="card-footer">
                  <div class="stats">
<br>                   <i class="material-icons">date_range</i> Dernier 24 heures
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning" style="width: 50%; background-color: rgb(41,195,72) !important ; ">
                  <h4 class="card-title" style="font-weight: bold;" >Les annonces</h4>
                  <p class="card-category">Derniére 5 annonces ajoutées</p>
                </div>
