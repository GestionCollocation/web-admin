...
<div class="modal fade" id="deleteComment{{$comments->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a  class="btn btn-danger" href="{{route('comments.destroy',$comments->id)}}" style="color: white;">Supprimer</a>
      </div>
    </div>
  </div>
</div>
